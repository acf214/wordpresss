<?php	
	...
	{	$ImageUrl1 = get_template_directory_uri() ."/images/slider-1.jpg";
		...
		'service_1_icons'=>"fa-pencil-square-o",
	...
	function reset_options_data() {
		...
		$chronicle_theme_options['snoweffect']='off';
		...
		if($_POST['option']=="theme_footer_options"){
			//footer customization 
			$chronicle_theme_options['footer_customizations']='Copyright @ 2018 WordPress.';
...
$theme_options = chronicle_get_options(); 

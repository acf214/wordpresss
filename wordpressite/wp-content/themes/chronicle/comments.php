<?php if ( post_password_required() ) : ?>
	<?php esc_html_e( 'This post is password protected. Enter the password to view any comments.', 'chronicle' ); ?></p>
	<?php return; endif; ?>
    <?php if ( have_comments() ) : ?>
	<h4 class="coment"><?php esc_html_e('Comments','chronicle'); ?></h4>
	<div class="mar_top_bottom_lines_small3"></div>	
	<?php wp_list_comments( array( 'callback' => 'chronicle_comment' ) ); ?>
	<?php if ( get_comment_pages_count() > 1 && get_option( 'page_comments' ) ) : ?>
		<nav id="comment-nav-below">
			<h5 class="assistive-text"><?php esc_html_e( 'Comment navigation', 'chronicle'); ?></h5>

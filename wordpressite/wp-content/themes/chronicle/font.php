...
.feature_section15 h1, .footer1 h4.lmb, h2.text{
	font-family : <?php echo esc_attr($chronicle_theme_options['title_font']); ?>;
}
...
.blog_post h3 a, h3.comment-reply-title{
	font-family : <?php echo esc_attr($chronicle_theme_options['desc_font']); ?>;
}
.readmore_but9, input#comment_submit{
	font-family : <?php echo esc_attr($chronicle_theme_options['btn_font']); ?>;
}
.feature_section15 strong, .chronicle_home_portfolio_caption h3 a, #blog_title a, .title h1, ul.breadcrumb li{
	font-family : <?php echo esc_attr($chronicle_theme_options['heading_title_font']); ?>;
}
.sidebar_title h4{
	font-family : <?php echo esc_attr($chronicle_theme_options['sidebar_title_font']); ?>;	
}
.sidebar_widget{
	font-family : <?php echo esc_attr($chronicle_theme_options['sidebar_desc_font']); ?>;	
}

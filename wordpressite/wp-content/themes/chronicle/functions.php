...
*/
	...
	* ==================*/
	function chronicle_scripts()
	{
		...
		wp_enqueue_style('chronicle-font-awesome', get_template_directory_uri() . '/css/font-awesome-4.7.0/css/font-awesome.css');	
		...
		wp_enqueue_style('chronicle-swiper', get_template_directory_uri() .'/css/swiper.min.css'); 
		// Js
		...
		wp_enqueue_script('chronicle-swiper', get_template_directory_uri() .'/js/swiper.js');
...
//Plugin Recommend
add_action('tgmpa_register','chronicle_plugin_recommend');
function chronicle_plugin_recommend(){
	$plugins = array(
	array(
...
if ( is_admin() && isset($_GET['activated'])  && $pagenow == "themes.php" ) {
	add_action( 'admin_notices', 'chronicle_activation_notice' );
}

add_action( 'admin_notices', 'chronicle_activation_notice' );
function chronicle_activation_notice(){
	//wp_register_style( 'custom_admin_css', get_template_directory_uri() . '/admin/admin-banner.css');
    wp_enqueue_style( 'custom_admin_css' );
	wp_enqueue_style('admin',  get_template_directory_uri() .'/core/admin/admin-themes.css');
    ?>
    <div class="notice notice-success is-dismissible"> 
		<p><?php echo esc_html__( 'Thanks for installing Chronicle! 
 Please visit our best theme, plugin & offers, make sure you visit our welcome page.', 'chronicle' ); ?>
		<a class="pro" target="_self" href="<?php echo admin_url('/themes.php?page=chronicle') ?>"><?php echo esc_html__( 'Visit Welcome Page', 'chronicle' ); ?></a></p>
	</div>
    <?php
}
?>
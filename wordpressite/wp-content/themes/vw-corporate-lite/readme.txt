/*----------------------------------------------------------------------------*/
/* VW Corporate Lite WordPress Theme */
/*---------------------------------------------------------------------------*/
...
VW Corporate Lite WordPress Theme has been created by VWthemes(vwthemes.com), 2017.
...
VW Corporate Lite WordPress Theme is derived from Corporate Lite flythemes WordPress Theme, Copyright 2013 Automattic, Inc.
Corporate Lite flythemes WordPress Theme is distributed under the terms of the GNU GPL
...
3 - Images used from Pixabay.
      ...
      Screenshot Url
        Bundled header image, Copyright Startup Stock Photos
        License: CC0 1.0 Universal (CC0 1.0)
        Source: https://www.pexels.com/photo/businessman-man-apple-laptop-7064/

        Bundled header image, Copyright CyberRabbit
        License: CC0 1.0 Universal (CC0 1.0)
        Source: https://www.pexels.com/photo/apple-computer-desk-laptop-209151/

        Bundled header image, Copyright Negative Space
        License: CC0 1.0 Universal (CC0 1.0)
        Source: https://www.pexels.com/photo/iphone-dark-notebook-pen-34140/
...
VW Corporate version
==========================================================
VW Corporate version is compatible with GPL licensed.
